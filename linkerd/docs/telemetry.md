...
`SCRIBE_ENABLED=true` environment variable set. Alternatively, to use Zipkin's
HTTP collector, use the `io.zipkin.http` telemeter plugin provided by the
[linkerd-zipkin](https://github.com/linkerd/linkerd-zipkin) repo.
</aside>
