...
* <a name="interpreter">*interpreter*</a> (optional) -- an
...
maintain to each destination host.  It must be an object containing keys:
  ...
  * *maxWaiters* -- Optional.  The maximum number of connection requests that
  ...
  Int.MaxValue)
* <a name="response_classifier">*responseClassifier*</a> -- Optional. A
...
* <a name="load_balancer">*loadBalancer*<a/> -- Optional.  A
  [load balancer](load_balancer.md) object.  (default: p2c)
* <a name="retries">*retries*</a> -- Optional. A [retry policy](retries.md) for all clients created by
  this router.
