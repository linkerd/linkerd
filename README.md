...
$ namerd/target/scala-2.11/namerd-0.7.0-SNAPSHOT-dcos-exec namerd/examples/zk.yaml
```
...
$ docker run -p 2181:2181 -p 4180:4180 -v /path/to/repo:/myapp -w /myapp buoyantio/namerd:0.7.0-SNAPSHOT-dcos namerd/examples/zk.yaml
```
