...
```
$ docker run -p 4140:4140 -p 9990:9990 -v /path/to/linkerd/linkerd/examples:/config buoyantio/linkerd:0.7.3-SNAPSHOT /config/static_namer.yaml
```
...
$ namerd/target/scala-2.11/namerd-0.7.3-SNAPSHOT-dcos-exec namerd/examples/zk.yaml
```
...
$ docker run -p 2181:2181 -p 4180:4180 -v /path/to/repo:/myapp -w /myapp buoyantio/namerd:0.7.3-SNAPSHOT-dcos namerd/examples/zk.yaml
```
