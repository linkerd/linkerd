...
// XXX blocked on https://github.com/twitter/finagle/pull/418
 ...
 */
private[buoyant] class XXX_ServiceFactoryCache[Key, Req, Rep](
  ...
  private[this] def oneshot(factory: ServiceFactory[Req, Rep], conn: ClientConnection): Future[Service[Req, Rep]] =
